...
const Header: React.FC<HeaderProps> = ({ onCalculatorToggle, isDashboardExpanded, onDashboardToggle, onEditBalances }) => {
    return (
        <header className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-2">
                 <button
                    ...
                    className="p-3 bg-zinc-800 hover:bg-zinc-700 rounded-full transition-colors duration-300 flex items-center gap-2"
                    aria-label="Edit Balances & Budget"
                    title="Edit Balances & Budget"
                >
                    <PencilIcon className="w-5 h-5 text-zinc-300" />
                </button>
                 <button
